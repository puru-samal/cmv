...
class F0:
    """
    F0 pitch info extractor using the yin algorithm
    """
    ...
    def estimate(
        ...
        Returns:
            ...
            cmnd_value: PyTorch tensor of the cumulative mean normalized difference function value at the estimated period
            unvoiced_predicate: PyTorch tensor of the unvoiced signal predicate
        """
        ...
        frames = F0._frame(signal, frame_length, frame_stride)
        cmdf = F0._diff(frames, tau_max)[..., tau_min:]
        tau = F0._search(cmdf, tau_max, threshold)
